...
const Footer = () => {
  ...
  <p className="text-gray-600 leading-6 md:max-w-[75%]">
    <strong>HealthConnect – Effortless Healthcare Scheduling
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-gray-600">
            <li>+91-20000-20000</li>
            <li>customersupport@Healthconnect.in</li>
          </ul>
        </div>
      </div>
      ...
      <p className="py-4 text-sm text-center text-gray-600">
        © 2026 Healthconnect.in — All Rights Reserved.
      </p>
    </div>
  );
};
